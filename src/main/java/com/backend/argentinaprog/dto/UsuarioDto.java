...
public class UsuarioDto {
    ...
    public UsuarioDto(String userName, String userLastname, String title, String phone, String email, String email2, String description, String pagGithub, String pagLinkedin) {
